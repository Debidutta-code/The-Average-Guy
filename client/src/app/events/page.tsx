    ...
    <main className="min-h-screen bg-black">
      ...
      <div className="pt-32 px-6 md:px-12 max-w-7xl mx-auto text-center">
        <h1 className="text-5xl md:text-8xl font-black text-white tracking-tighter uppercase">
          COMMUNITY <span className="text-brand-orange">EVENTS</span>
        </h1>
      ...
      <div className="pb-24 px-6 md:px-12 max-w-7xl mx-auto">
        <h3 className="text-2xl font-bold text-white mb-12 uppercase tracking-tighter">Past Memories</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <div key={i} className="bg-zinc-900/50 p-6 rounded-2xl border border-white/5 group hover:border-brand-orange transition-colors">
