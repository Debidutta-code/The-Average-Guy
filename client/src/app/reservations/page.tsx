    ...
    <main className="min-h-screen bg-background">
      ...
      <div className="pt-32 pb-24 px-6 md:px-12 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          <div>
            <h1 className="text-5xl md:text-8xl font-black text-foreground tracking-tighter uppercase leading-[0.9] mb-8">
              SECURE <br />
          ...
          <div className="bg-zinc-900 p-8 md:p-12 rounded-3xl border border-white/5 shadow-2xl relative overflow-hidden">
            <div className="absolute top-0 right-0 p-8 opacity-5">
              <span className="text-8xl font-black text-foreground">OTC</span>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input id="phone" required placeholder="+91 00000 00000" className="bg-white/5 border-white/10 text-foreground h-12" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="guests" className="text-white/60">Number of Guests</Label>
                  <Input id="guests" type="number" min="1" required placeholder="2" className="bg-white/5 border-white/10 text-foreground h-12" />
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <Label htmlFor="date" className="text-white/60">Reservation Date</Label>
                  <Input id="date" type="date" required className="bg-white/5 border-white/10 text-foreground h-12" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="time" className="text-white/60">Preferred Time</Label>
                  <Input id="time" type="time" required className="bg-white/5 border-white/10 text-foreground h-12" />
                </div>
              </div>
              <div className="space-y-2">
                <Label htmlFor="notes" className="text-white/60">Special Requests (Optional)</Label>
                <Textarea id="notes" placeholder="Any dietary preferences or special occasions..." className="bg-white/5 border-white/10 text-foreground min-h-[100px]" />
              </div>
