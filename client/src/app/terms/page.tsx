    ...
    <main className="bg-background min-h-screen text-foreground">
      ...
      <div className="pt-40 pb-20 px-6 max-w-4xl mx-auto space-y-12">
        <div className="space-y-4">
          <h1 className="text-5xl md:text-7xl font-black tracking-tighter uppercase">Terms of <span className="text-primary">Service</span></h1>
        ...
        <section className="space-y-6 text-white/70 leading-relaxed text-lg">
          <p>
            Welcome to Old Town Cafe. By accessing our website or using our services, you agree to comply with and be bound by the following terms and conditions.
          </p>

          <div className="space-y-4 pt-8">
            <h2 className="text-2xl font-bold text-foreground uppercase tracking-tight">1. Use of Website</h2>
            <p>
          ...
          <div className="space-y-4 pt-8">
            <h2 className="text-2xl font-bold text-foreground uppercase tracking-tight">2. Reservations & Events</h2>
            <p>
          ...
          <div className="space-y-4 pt-8">
            <h2 className="text-2xl font-bold text-foreground uppercase tracking-tight">3. Conduct</h2>
            <p>
          ...
          <div className="space-y-4 pt-8 border-t border-white/5 mt-12">
            <h2 className="text-2xl font-bold text-foreground uppercase tracking-tight">Contact</h2>
            <p>
