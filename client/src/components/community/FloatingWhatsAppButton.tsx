...
export function FloatingWhatsAppButton({ whatsappLink }: FloatingWhatsAppButtonProps) {
  return (
    ...
    >
      <div className="absolute -inset-4 bg-brand-gold/20 rounded-full blur-xl group-hover:bg-brand-gold/40 transition-all duration-500 animate-pulse" />
      <div className="relative w-16 h-16 bg-brand-gold rounded-full flex items-center justify-center text-white shadow-2xl shadow-brand-gold/50">
