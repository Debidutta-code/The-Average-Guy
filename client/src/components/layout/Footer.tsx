      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-white/50">
            ...
            <li><Link href="/events" className="hover:text-foreground transition-colors">Upcoming Events</Link></li>
            <li><Link href="/menu" className="hover:text-foreground transition-colors">Our Menu</Link></li>
        ...
        <div>
          ...
          <div className="relative">
            ...
            />
            <button className="absolute right-2 top-2 bottom-2 bg-primary text-foreground text-xs font-bold px-4 rounded-md">
              Join
            </button>
          </div>
        </div>
